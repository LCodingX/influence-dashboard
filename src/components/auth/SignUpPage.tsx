        ...
        <div className="w-full max-w-md">
          <div className="rounded-xl border border-navy-700 bg-navy-800 p-8 shadow-2xl">
            <div className="text-center">
              ...
              <Link
                to="/login"
                className="mt-6 inline-block text-sm font-medium text-blue-400 transition-colors duration-150 hover:text-blue-300"
              >
                Back to sign in
              </Link>
            </div>
      ...
      <div className="w-full max-w-md">
        <div className="rounded-xl border border-navy-700 bg-navy-800 p-8 shadow-2xl">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-slate-400">
              Get started with the Influence Dashboard
            </p>
          </div>
